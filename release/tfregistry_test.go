...
func (c *mockTFRegistryClient) ModuleLatestForProvider(_ context.Context, _ *tfregistry.ModuleLatestForProviderRequest) (*tfregistry.ModuleLatestForProviderResponse, error) { // nolint revive unused-parameter
    return c.moduleRes, c.err
}

func (c *mockTFRegistryClient) ProviderLatest(_ context.Context, _ *tfregistry.ProviderLatestRequest) (*tfregistry.ProviderLatestResponse, error) { // nolint revive unused-parameter
