...
func (c *mockGitLabClient) ProjectListReleases(_ context.Context, _, _ string, _ *gitlab.ListReleasesOptions) ([]*gitlab.Release, *gitlab.Response, error) { // nolint revive unused-parameter
