...
func (c *mockProviderDownloaderClient) ProviderDownload(_ context.Context, _ *ProviderDownloadRequest) (*ProviderDownloadResponse, error) { // nolint revive unused-parameter
...
func TestIndexGetOrCreateProviderVersion(t *testing.T) {
    ...
    for _, address := range []string{"minamijoyo/dummy", "minamijoyo/null"} {
        for _, version := range []string{"3.2.1", "3.2.2"} {
            ...
            var mockResponses []*ProviderDownloadResponse
