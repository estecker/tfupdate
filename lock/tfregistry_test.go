...
func (c *mockTFRegistryClient) ProviderPackageMetadata(context.Context, *tfregistry.ProviderPackageMetadataRequest) (*tfregistry.ProviderPackageMetadataResponse, error) { // nolint revive unused-parameter
